...
const ProductContractDetails = ({
  ...
  const [contractSubType, setContractSubType] = useState(null);
  ...
  const onContractPeriodChangeHandler = (e) => {
    form?.setFieldsValue({
      contract_details: {
        start_date: '',
        end_date: '',
  ...
  const getDateOnSelection = () => {
    if (productDetail && productDetail?.warranty_end_date) {
      return moment(productDetail?.warranty_end_date);
    } else {
  ...
  }, [contractType, isAddAfterWarrantyVisible]);
      ...
      <Row gutter={[24, 0]} className="px-6 pt-3">
        ...
        <Col lg={12} xl={12} md={24} sm={24} xs={24}>
          ...
          <SelectInput
            ...
            onClear={() => setContractSubType(null)}
        ...
        <Col lg={12} xl={12} md={24} sm={24} xs={24}>
          ...
          <NumberInput
            ...
            initialValue={1}
            min={1}
            onChange={onContractPeriodChangeHandler}
          />
        </Col>
        <Col lg={12} xl={12} md={24} sm={24} xs={24}>
