...
const DisplayProductDocuments = ({
  ...
  const sharedColumns = [
    ...
    },
    {
      ...
      render: (data) => (
        <div className="capitalize text-xs">{(data && moment(data).format('LL')) || 'n/a'}</div>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (data) => <div className=" capitalize text-xs w-full">{data || 'n/a'}</div>,
    },
    {
  ...
  const internalColumns = [
    ...
    },
    {
      ...
      render: (data) => (
        <div className="mx-2 capitalize text-xs">
          {(data && moment(data).format('LL')) || 'n/a'}
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (data, record) => (
        <div className="mx-2 capitalize text-xs">
          <div className="font-semibold">{data?.name || 'n/a'}</div>
          <div>
            {(record?.createdAt && moment(record?.createdAt).format('LL')) || 'n/a'}
            <span className="lowercase"> at </span>
            {(record?.createdAt && moment(record?.createdAt).format('LT')) || 'n/a'}
          </div>
        </div>
      ),
    },
